...
var G__34643 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(choices,new_index);
return (id_fn.cljs$core$IFn$_invoke$arity$1 ? id_fn.cljs$core$IFn$_invoke$arity$1(G__34643) : id_fn.call(null,G__34643));
} else {
return null;
}
});
...
var group_headers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34644_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"group","group",582596132)],[cljs.core.gensym.cljs$core$IFn$_invoke$arity$0(),p1__34644_SHARP_]);
...
var G__34648_34704 = event.target.value;
(set_filter_text.cljs$core$IFn$_invoke$arity$1 ? set_filter_text.cljs$core$IFn$_invoke$arity$1(G__34648_34704) : set_filter_text.call(null,G__34648_34704));
 ...
 */
re_com.dropdown.filter_text_box = cljs.core.with_meta(re_com.dropdown.filter_text_box_base,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__34649_SHARP_){
var node = reagent.dom.dom_node(p1__34649_SHARP_).firstChild;
return node.focus();
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (p1__34650_SHARP_){
var node = reagent.dom.dom_node(p1__34650_SHARP_).firstChild;
return node.focus();
})], null));
/**
...
var text = (cljs.core.truth_(cljs.core.deref(internal_model))?(function (){var G__34652 = re_com.util.item_for_id.cljs$core$IFn$_invoke$arity$variadic(cljs.core.deref(internal_model),choices,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"id-fn","id-fn",316222798),id_fn], 0));
return (label_fn.cljs$core$IFn$_invoke$arity$1 ? label_fn.cljs$core$IFn$_invoke$arity$1(G__34652) : label_fn.call(null,G__34652));
})():placeholder);
...
var callback = (function (p__34655){
var map__34656 = p__34655;
var map__34656__$1 = cljs.core.__destructure_map(map__34656);
var args = map__34656__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34656__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34656__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
var G__34657 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"filter-text","filter-text",-381699202),text,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668),regex_filter_QMARK_], null);
var G__34658 = (function (p1__34653_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"result","result",1415092211),p1__34653_SHARP_], null));
});
var G__34659 = (function (p1__34654_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__34654_SHARP_], null));
});
return (choices.cljs$core$IFn$_invoke$arity$3 ? choices.cljs$core$IFn$_invoke$arity$3(G__34657,G__34658,G__34659) : choices.call(null,G__34657,G__34658,G__34659));
});
/**
...
var temp__5753__auto___34705 = new cljs.core.Keyword(null,"timer","timer",-1266967739).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
if(cljs.core.truth_(temp__5753__auto___34705)){
var timer_34706 = temp__5753__auto___34705;
clearTimeout(timer_34706);
} else {
}
...
var len__4829__auto___34707 = arguments.length;
var i__4830__auto___34708 = (0);
while(true){
if((i__4830__auto___34708 < len__4829__auto___34707)){
args__4835__auto__.push((arguments[i__4830__auto___34708]));

var G__34709 = (i__4830__auto___34708 + (1));
i__4830__auto___34708 = G__34709;
continue;
} else {
}
break;
...
(re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic = (function (p__34674){
var map__34675 = p__34674;
var map__34675__$1 = cljs.core.__destructure_map(map__34675);
var args = map__34675__$1;
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34675__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34675__$1,new cljs.core.Keyword(null,"model","model",331153215));
var regex_filter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34675__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var debounce_delay = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__34675__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982),(250));
...
var set_filter_text = (function (text,p__34678,debounce_QMARK_){
var map__34679 = p__34678;
var map__34679__$1 = cljs.core.__destructure_map(map__34679);
var args__$1 = map__34679__$1;
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34679__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
...
return (function() { 
var G__34710__delegate = function (p__34680){
var map__34681 = p__34680;
var map__34681__$1 = cljs.core.__destructure_map(map__34681);
var args__$1 = map__34681__$1;
var group_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__34681__$1,new cljs.core.Keyword(null,"group-fn","group-fn",129203707),new cljs.core.Keyword(null,"group","group",582596132));
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var model__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__34681__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263),new cljs.core.Keyword(null,"label","label",1718410804));
var tab_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"tab-index","tab-index",895755393));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var title_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"title?","title?",-1510254555));
var render_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__34681__$1,new cljs.core.Keyword(null,"render-fn","render-fn",398796518),label_fn);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var choices__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__34681__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798),new cljs.core.Keyword(null,"id","id",-1388402092));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var debounce_delay__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var filter_box_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34681__$1,new cljs.core.Keyword(null,"filter-box?","filter-box?",-1157583688));
...
var callback = (function (p1__34664_SHARP_){
cljs.core.reset_BANG_(internal_model,p1__34664_SHARP_);
...
var G__34685_34711 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__34685_34711) : on_change.call(null,G__34685_34711));
} else {
}
...
var G__34686_34713 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__34686_34713) : on_change.call(null,G__34686_34713));
} else {
}
...
var key_handler = (function (p1__34665_SHARP_){
if(cljs.core.truth_(disabled_QMARK___$1)){
return false;
} else {
var G__34689 = p1__34665_SHARP_.which;
switch (G__34689) {
case (13):
return press_enter();
...
})())?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li.error","li.error",534172652),new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state))], null):(((cljs.core.count(filtered_choices) > (0)))?(function (){var vec__34693 = re_com.dropdown.choices_with_group_headings(filtered_choices,group_fn);
var group_names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34693,(0),null);
var group_opt_lists = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34693,(1),null);
...
var make_choices = (function (p1__34667_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(make_a_choice,p1__34667_SHARP_);
});
...
while (G__34719__i < G__34719__a.length) {G__34719__a[G__34719__i] = arguments[G__34719__i + 0]; ++G__34719__i;}
  p__34680 = new cljs.core.IndexedSeq(G__34719__a,0,null);
} 
return G__34710__delegate.call(this,p__34680);};
G__34710.cljs$lang$maxFixedArity = 0;
G__34710.cljs$lang$applyTo = (function (arglist__34720){
var p__34680 = cljs.core.seq(arglist__34720);
return G__34710__delegate(p__34680);
});
...
/** @this {Function} */
(re_com.dropdown.single_dropdown.cljs$lang$applyTo = (function (seq34668){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq34668));
}));
