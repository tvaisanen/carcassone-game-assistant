...
var o29925 = temp__5751__auto__;
var temp__5751__auto____$1 = (o29925["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o29926 = temp__5751__auto____$1;
return (o29926["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27391__auto__ = f;
return (o__27391__auto__["toString"]).call(o__27391__auto__);
} else {
return "";
}
}catch (e29929){var _ = e29929;
return "";
}});
...
try{var o__27391__auto___30258 = t;
(o__27391__auto___30258["cljs$lang$ctorPrWriter"]).call(o__27391__auto___30258,t,writer);
}catch (e29934){var __30259 = e29934;
}
...
var char_code = (function (){var o__27391__auto__ = (new String(char$));
return (o__27391__auto__["charCodeAt"]).call(o__27391__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27391__auto__ = String;
return (o__27391__auto__["fromCharCode"]).call(o__27391__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29936 = num_code;
switch (G__29936) {
case (1):
return (185);
...
var o__27391__auto__ = String;
return (o__27391__auto__["fromCharCode"]).call(o__27391__auto__,superscript_code);
});
/**
...
}catch (e29939){var _e__27401__auto__ = e29939;
return false;
}})())){
...
var vec__29940 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29940,(0),null);
...
var len__4829__auto___30311 = arguments.length;
var i__4830__auto___30312 = (0);
while(true){
if((i__4830__auto___30312 < len__4829__auto___30311)){
args__4835__auto__.push((arguments[i__4830__auto___30312]));

var G__30315 = (i__4830__auto___30312 + (1));
i__4830__auto___30312 = G__30315;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29951){
var vec__29952 = p__29951;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29952,(0),null);
...
var G__30320 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30321 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30320;
remaining_tokens = G__30321;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29949){
var G__29950 = cljs.core.first(seq29949);
var seq29949__$1 = cljs.core.next(seq29949);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29950,seq29949__$1);
}));
...
var vec__29967 = cljs.core.split_with((function (p1__29964_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29964_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29967,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29967,(1),null);
...
var vec__29979 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29979,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29979,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30326 = cljs.core.rest(remaining_tokens);
var G__30327 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30326;
name_tokens = G__30327;
continue;
} else {
...
var vec__29994 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29994,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29994,(1),null);
var vec__29997 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29997,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29997,(1),null);
var vec__30000 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30000,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30000,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30000,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30000,(3),null);
...
var vec__30006 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30006,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30006,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30006,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30006,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30006,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30006,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__30009 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30009,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30009,(1),null);
var vec__30012 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30012,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30012,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__30020 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__30020) : devtools.munging.parse_fn_info_deep.call(null,G__30020));
})()));
}
} else {
return fn_info;
...
var G__30360 = (arity + (1));
var G__30361 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30055){
var vec__30056 = p__30055;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30056,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30056,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30069_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30069_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30070_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30070_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___30362 = arguments.length;
var i__4830__auto___30363 = (0);
while(true){
if((i__4830__auto___30363 < len__4829__auto___30362)){
args__4835__auto__.push((arguments[i__4830__auto___30363]));

var G__30364 = (i__4830__auto___30363 + (1));
i__4830__auto___30363 = G__30364;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30084){
var vec__30085 = p__30084;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30085,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30071){
var G__30072 = cljs.core.first(seq30071);
var seq30071__$1 = cljs.core.next(seq30071);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30072,seq30071__$1);
}));
...
var map__30089 = options;
var map__30089__$1 = cljs.core.__destructure_map(map__30089);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30089__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30089__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30089__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30089__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30090 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30090,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30090,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30090,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30090,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30090,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30090,(5),null);
...
var o__27391__auto__ = f;
return (o__27391__auto__["getBasis"]).call(o__27391__auto__);
});
/**
...
}catch (e30106){var _e__27401__auto__ = e30106;
...
var G__30367 = (obj[cljs.core.first(path)]);
var G__30368 = cljs.core.rest(path);
obj = G__30367;
path = G__30368;
continue;
} else {
...
var _STAR_ = (function (accum,p__30117){
var vec__30118 = p__30117;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30118,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30118,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30122){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30124,(2),null);
...
var post_process = (function (p__30148){
var vec__30149 = p__30148;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30149,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30149,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30128_SHARP_){
return (obj[cljs.core.first(p1__30128_SHARP_)]);
}),sorted_matches);
