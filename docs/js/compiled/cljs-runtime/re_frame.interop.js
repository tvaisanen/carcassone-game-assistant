...
return [(function (){var pred__31358 = cljs.core.instance_QMARK_;
var expr__31359 = reactive_val;
if(cljs.core.truth_((pred__31358.cljs$core$IFn$_invoke$arity$2 ? pred__31358.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__31359) : pred__31358.call(null,reagent.ratom.RAtom,expr__31359)))){
return "ra";
} else {
if(cljs.core.truth_((pred__31358.cljs$core$IFn$_invoke$arity$2 ? pred__31358.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__31359) : pred__31358.call(null,reagent.ratom.RCursor,expr__31359)))){
return "rc";
} else {
if(cljs.core.truth_((pred__31358.cljs$core$IFn$_invoke$arity$2 ? pred__31358.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__31359) : pred__31358.call(null,reagent.ratom.Reaction,expr__31359)))){
return "rx";
} else {
if(cljs.core.truth_((pred__31358.cljs$core$IFn$_invoke$arity$2 ? pred__31358.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__31359) : pred__31358.call(null,reagent.ratom.Track,expr__31359)))){
return "tr";
} else {
return "other";
}
