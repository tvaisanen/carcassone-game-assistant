...
var len__4829__auto___30408 = arguments.length;
var i__4830__auto___30409 = (0);
while(true){
if((i__4830__auto___30409 < len__4829__auto___30408)){
args__4835__auto__.push((arguments[i__4830__auto___30409]));

var G__30410 = (i__4830__auto___30409 + (1));
i__4830__auto___30409 = G__30410;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30381){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30396_SHARP_){
return (!((cljs.core.meta(p1__30396_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30397__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30398){var _e__27401__auto__ = e30398;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e30400){var _e__27401__auto__ = e30400;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30402 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30403 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30403);

try{var map__30404 = opts;
var map__30404__$1 = cljs.core.__destructure_map(map__30404);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30404__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30402);
}});
...
var temp__5751__auto___30411 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___30411)){
var managed_print_level_30412 = temp__5751__auto___30411;
var _STAR_print_level_STAR__orig_val__30406_30413 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30407_30414 = managed_print_level_30412;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30407_30414);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30405_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30405_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30406_30413);
}} else {
job_fn();
}
