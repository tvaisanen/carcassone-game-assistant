...
var periods__$1 = cljs.core.vec((function (){var G__34474 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34473_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__34473_SHARP_,(0),(3));
}),G__34474);
} else {
return G__34474;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__34480){
var vec__34481 = p__34480;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34481,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34481,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__34484 = pattern;
switch (G__34484) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34484)].join('')));
...
return p1__34485_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__34486_SHARP_){
return p1__34486_SHARP_.getSeconds();
});
...
return p1__34488_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__34489_SHARP_){
return p1__34489_SHARP_.getHours();
});

break;
case "day":
return (function (p1__34490_SHARP_){
return p1__34490_SHARP_.getDate();
});

break;
case "month":
return (function (p1__34491_SHARP_){
return p1__34491_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__34492_SHARP_){
return p1__34492_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34493__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__34494){
...
var key = first__34497;
var args = seq__34496__$1;
var G__34498 = key;
...
break;
case "ordinal-suffix":
var vec__34499 = (function (){var G__34502 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__34502) : syntax_list.call(null,G__34502));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34499,(0),null);
...
var d = value;
var G__34506 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
...
var unparser = first__34509;
var more = seq__34508__$1;
var s = "";
var d__$1 = d;
...
var unparser__$1 = first__34518;
var more__$1 = seq__34517__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__34519 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34519,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34519,(1),null);
var G__34548 = d__$3;
var G__34549 = more__$1;
var G__34550 = s__$3;
d__$1 = G__34548;
G__34506__$1 = G__34549;
s__$1 = G__34550;
continue;
}
break;
