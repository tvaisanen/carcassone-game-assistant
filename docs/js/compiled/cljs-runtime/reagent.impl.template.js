...
var G__31205 = o;
goog.object.set(G__31205,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__31223__delegate = function (args){
...
while (G__31224__i < G__31224__a.length) {G__31224__a[G__31224__i] = arguments[G__31224__i + 0]; ++G__31224__i;}
  args = new cljs.core.IndexedSeq(G__31224__a,0,null);
} 
return G__31223__delegate.call(this,args);};
G__31223.cljs$lang$maxFixedArity = 0;
G__31223.cljs$lang$applyTo = (function (arglist__31225){
var args = cljs.core.seq(arglist__31225);
return G__31223__delegate(args);
});
...
var G__31206 = o;
goog.object.set(G__31206,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__31226__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__31227__i < G__31227__a.length) {G__31227__a[G__31227__i] = arguments[G__31227__i + 0]; ++G__31227__i;}
  args = new cljs.core.IndexedSeq(G__31227__a,0,null);
} 
return G__31226__delegate.call(this,args);};
G__31226.cljs$lang$maxFixedArity = 0;
G__31226.cljs$lang$applyTo = (function (arglist__31228){
var args = cljs.core.seq(arglist__31228);
return G__31226__delegate(args);
});
...
var G__31207 = props;
var G__31207__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31207,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__31207);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31207__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__31208 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31208,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__31208;
}
})(),id_class);
...
var G__31209 = (cljs.core.count(argv) - first_child);
switch (G__31209) {
case (0):
...
var vec__31210 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31210,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31210,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31210,(2),null);
...
var temp__5757__auto___31236 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___31236 == null)){
} else {
var key_31238 = temp__5757__auto___31236;
(jsprops.key = key_31238);
}
...
var temp__5757__auto___31241 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___31241 == null)){
} else {
var key_31242 = temp__5757__auto___31241;
...
var temp__5757__auto___31244 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___31244 == null)){
} else {
var key_31245 = temp__5757__auto___31244;
(jsprops.key = key_31245);
}
...
var temp__5757__auto___31251 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___31251 == null)){
} else {
var key_31252 = temp__5757__auto___31251;
(jsprops.key = key_31252);
}
...
var temp__5757__auto___31254 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___31254 == null)){
} else {
var key_31255 = temp__5757__auto___31254;
(jsprops.key = key_31255);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31213_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__31213_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__31214 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31214,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31214,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template31220 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template31220 = (function (opts,id,fn_to_element,parse_fn,meta31221){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template31220.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31222,meta31221__$1){
var self__ = this;
var _31222__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template31220(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta31221__$1));
}));

(reagent.impl.template.t_reagent$impl$template31220.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31222){
var self__ = this;
var _31222__$1 = this;
return self__.meta31221;
}));

(reagent.impl.template.t_reagent$impl$template31220.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template31220.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template31220.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template31220.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template31220.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template31220.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta31221","meta31221",1263605444,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template31220.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template31220.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template31220");

(reagent.impl.template.t_reagent$impl$template31220.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template31220");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template31220.
 */
reagent.impl.template.__GT_t_reagent$impl$template31220 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template31220(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta31221){
return (new reagent.impl.template.t_reagent$impl$template31220(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta31221));
});

}

return (new reagent.impl.template.t_reagent$impl$template31220(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
