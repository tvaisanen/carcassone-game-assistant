...
var G__30365 = devtools.prefs.pref(v);
v = G__30365;
continue;
} else {
return v;
...
}catch (e30201){var _e__27401__auto__ = e30201;
return false;
}})();
...
}catch (e30208){var _e__27401__auto__ = e30208;
return false;
}})();
...
}catch (e30213){var _e__27401__auto__ = e30213;
return false;
}}
}
});
...
var vec__30340 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30340,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30340,(1),null);
...
return cljs.core.some((function (p1__30343_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30343_SHARP_);
}),template);
});
