...
var G__33973 = clojure.zip.node(loc);
var fexpr__33972 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__33972.cljs$core$IFn$_invoke$arity$1 ? fexpr__33972.cljs$core$IFn$_invoke$arity$1(G__33973) : fexpr__33972.call(null,G__33973));
});
/**
...
var G__33975 = clojure.zip.node(loc);
var fexpr__33974 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var fexpr__33976 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__33976.cljs$core$IFn$_invoke$arity$2 ? fexpr__33976.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__33976.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__33977 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33977,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33977,(1),null);
var vec__33980 = clojure.zip.children(loc);
...
var vec__33983 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33983,(0),null);
var map__33986 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33983,(1),null);
var map__33986__$1 = cljs.core.__destructure_map(map__33986);
var path = map__33986__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33986__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33986__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33986__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33986__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33986__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__33987 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33987,(0),null);
var map__33990 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33987,(1),null);
var map__33990__$1 = cljs.core.__destructure_map(map__33990);
var path = map__33990__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33990__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__33991 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33990__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__33994 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33994,(0),null);
var map__33997 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33994,(1),null);
var map__33997__$1 = cljs.core.__destructure_map(map__33997);
var path = map__33997__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33997__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33997__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return r;
} else {
...
var vec__33998 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33998,(0),null);
var map__34001 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33998,(1),null);
var map__34001__$1 = cljs.core.__destructure_map(map__34001);
var path = map__34001__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34001__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34001__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
...
var vec__34002 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34002,(0),null);
var map__34005 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34002,(1),null);
var map__34005__$1 = cljs.core.__destructure_map(map__34005);
var path = map__34005__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34005__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34005__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__34006 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34006,(0),null);
var map__34009 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34006,(1),null);
var map__34009__$1 = cljs.core.__destructure_map(map__34009);
var path = map__34009__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34009__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__34010 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34010,(0),null);
var map__34013 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34010,(1),null);
var map__34013__$1 = cljs.core.__destructure_map(map__34013);
var path = map__34013__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34013__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__34014 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34014,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34014,(1),null);
...
var len__4829__auto___34065 = arguments.length;
var i__4830__auto___34066 = (0);
while(true){
if((i__4830__auto___34066 < len__4829__auto___34065)){
args__4835__auto__.push((arguments[i__4830__auto___34066]));

var G__34068 = (i__4830__auto___34066 + (1));
i__4830__auto___34066 = G__34068;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq34017){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34018,G__34019,seq34017__$2);
}));
...
var G__34072 = clojure.zip.rightmost(child);
loc__$1 = G__34072;
continue;
} else {
return loc__$1;
...
var vec__34020 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34020,(0),null);
var map__34023 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34020,(1),null);
var map__34023__$1 = cljs.core.__destructure_map(map__34023);
var path = map__34023__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34023__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34023__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34023__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34023__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__34075 = clojure.zip.rightmost(child);
loc__$1 = G__34075;
continue;
} else {
return loc__$1;
