...
var G__38946 = cljs.tools.reader.reader_types.peek_char(rdr);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__38946)){
...
var vec__38949 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(s,/\s+/,(2));
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38949,(0),null);
var rest = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38949,(1),null);
...
try{var map__38954 = re_frisk.filter.filter_parser.read_string_SINGLEQUOTE_(s);
var map__38954__$1 = cljs.core.__destructure_map(map__38954);
var foo = map__38954__$1;
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38954__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38954__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
...
try{var map__38961 = re_frisk.filter.filter_parser.read_string_SINGLEQUOTE_(s);
var map__38961__$1 = cljs.core.__destructure_map(map__38961);
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38961__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38961__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"expr","expr",745722291),val], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),rest], null);
}catch (e38956){var _ = e38956;
var vec__38958 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(s,/\s+/,(2));
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38958,(0),null);
var rest = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38958,(1),null);
...
var G__38967 = cljs.core.first(s);
switch (G__38967) {
case "[":
case "(":
case "{":
...
var map__38968 = re_frisk.filter.filter_parser.parse_part(s__$2);
var map__38968__$1 = cljs.core.__destructure_map(map__38968);
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38968__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38968__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
