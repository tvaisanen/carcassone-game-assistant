...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32719 = c;
var G__32719__$1 = (((G__32719 == null))?null:G__32719.prototype);
if((G__32719__$1 == null)){
return null;
} else {
return G__32719__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32720 = c;
var G__32720__$1 = (((G__32720 == null))?null:G__32720.prototype);
if((G__32720__$1 == null)){
return null;
} else {
return G__32720__$1.render;
}
})() == null)))));
});
...
while (G__32823__i < G__32823__a.length) {G__32823__a[G__32823__i] = arguments[G__32823__i + 0]; ++G__32823__i;}
  args = new cljs.core.IndexedSeq(G__32823__a,0,null);
} 
...
var args = cljs.core.seq(arglist__32824);
...
var or__4223__auto__ = (function (){var G__32733 = c;
var G__32733__$1 = (((G__32733 == null))?null:G__32733.constructor);
if((G__32733__$1 == null)){
return null;
} else {
return G__32733__$1.displayName;
}
})();
...
var G__32735 = c;
var G__32735__$1 = (((G__32735 == null))?null:G__32735.constructor);
if((G__32735__$1 == null)){
return null;
} else {
return G__32735__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__32736 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32737 = c;
(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32737);
...
}finally {(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32736);
}});
...
var c = this;
var G__32799_32829 = goog.object.get(c,"cljsRatom");
if((G__32799_32829 == null)){
} else {
re_frisk.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__32799_32829);
}
...
var renders_32830 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_32831 = cljs.core.first(cljs.core.vals(renders_32830));
...
if((cljs.core.count(renders_32830) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_32830))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_32831)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_32831], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var or__4223__auto____$1 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.util.fun_name(render_fun);
...
var G__32811 = o;
goog.object.set(G__32811,cljs.core.name(k),v);
...
return goog.object.get(c,re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.protocols.get_id(compiler));
});
...
goog.object.set(c,re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.protocols.get_id(compiler),constructor$);
...
while (G__32834__i < G__32834__a.length) {G__32834__a[G__32834__i] = arguments[G__32834__i + 0]; ++G__32834__i;}
  args = new cljs.core.IndexedSeq(G__32834__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__32812 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32813 = c;
(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32813);
...
}finally {(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32812);
}});
...
var vec__32814 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32814,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32814,(1),null);
...
var G__32817 = goog.object.get(reagent_state,"cljsRatom");
if((G__32817 == null)){
return null;
} else {
return re_frisk.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__32817);
}
});
}),[]);
...
var or__4223__auto__ = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.cached_react_class(compiler,tag);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
